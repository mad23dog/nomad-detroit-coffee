...
module.exports = async function handler(req, res) {
    ...
    try {
        ...
        await client.query(
            'INSERT INTO orders (order_id, customer_email, customer_name, total_amount, shipping_amount, status, paypal_order_id) VALUES ($1, $2, $3, $4, $5, $6, $7)',
            [orderId, customerEmail, customerName, total, shippingCost, 'pending', paypalOrderId]
        );
